...
use App\Repository\InstagramBotFlowRepository;
...
#[ORM\Entity(repositoryClass: InstagramBotFlowRepository::class)]
class InstagramBotFlow implements TenantAwareInterface
{
