...
use App\Repository\InstagramActionButtonRepository;
...
#[ORM\Entity(repositoryClass: InstagramActionButtonRepository::class)]
class InstagramActionButton implements TenantAwareInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: InstagramBotFlow::class)]
    #[ORM\JoinColumn(name: "Instagram_bot_flow_id", referencedColumnName: "id", onDelete: "SET NULL")]
    private ?InstagramBotFlow $botFlow = null;
    ...
    public function getBotFlow(): ?InstagramBotFlow
    {
        return $this->botFlow;
    }

    public function setBotFlow(?InstagramBotFlow $botFlow): static
    {
