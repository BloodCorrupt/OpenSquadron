...
use App\Repository\FacebookDripSequenceRepository;
...
#[ORM\Entity(repositoryClass: FacebookDripSequenceRepository::class)]
class FacebookDripSequence implements TenantAwareInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
