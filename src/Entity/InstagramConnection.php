...
use App\Repository\InstagramConnectionRepository;
...
#[ORM\Entity(repositoryClass: InstagramConnectionRepository::class)]
#[ORM\Table(name: 'Instagram_connection')]
#[ORM\HasLifecycleCallbacks]
class InstagramConnection implements TenantAwareInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    /**
     * @var \Doctrine\Common\Collections\Collection<int, InstagramCommentAutomation>
     */
    #[ORM\OneToMany(mappedBy: 'InstagramConnection', targetEntity: InstagramCommentAutomation::class, orphanRemoval: true)]
    ...
    public function getLinkedFacebookPageId(): ?string
    {
        return $this->linkedFacebookPageId;
    }

    public function setLinkedFacebookPageId(?string $linkedFacebookPageId): static
    {
        $this->linkedFacebookPageId = $linkedFacebookPageId;
        return $this;
    }
