...
class BotFlow
{
     ...
     * for simplicity; parsed at runtime by the BotFlowExecutor.
     */
    ...
    /**
     * Either the legacy flat-array format `[{type, text}, ...]` OR the new
     * graph format `{format:'graph', nodes:[...], edges:[...], viewport:{...}}`.
     */
