...
use App\Repository\FacebookActionButtonRepository;
...
#[ORM\Entity(repositoryClass: FacebookActionButtonRepository::class)]
class FacebookActionButton implements TenantAwareInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\JoinColumn(name: "facebook_bot_flow_id", referencedColumnName: "id", onDelete: "SET NULL")]
    private ?FacebookBotFlow $botFlow = null;
    ...
    public function getBotFlow(): ?FacebookBotFlow
    {
        return $this->botFlow;
    }

    public function setBotFlow(?FacebookBotFlow $botFlow): static
    {
