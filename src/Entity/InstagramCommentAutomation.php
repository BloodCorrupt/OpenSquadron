...
use App\Repository\InstagramCommentAutomationRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: InstagramCommentAutomationRepository::class)]
class InstagramCommentAutomation
{
    ...
    #[ORM\OneToMany(mappedBy: 'automationCampaign', targetEntity: InstagramCommentAutomationRule::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    /**
     * @return Collection<int, InstagramCommentAutomationRule>
     */
    ...
    public function addRule(InstagramCommentAutomationRule $rule): static
    {
    ...
    public function removeRule(InstagramCommentAutomationRule $rule): static
    {
    ...
    public function populateFromSettingsArray(array $settings): static
    {
        ...
        if (is_array($rules)) {
            foreach ($rules as $ruleData) {
                $rule = new InstagramCommentAutomationRule();
