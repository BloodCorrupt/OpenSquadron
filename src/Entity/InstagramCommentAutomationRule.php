...
#[ORM\Entity]
class InstagramCommentAutomationRule
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?InstagramCommentAutomation $automationCampaign = null;
    ...
    public function getAutomationCampaign(): ?InstagramCommentAutomation
    {
        return $this->automationCampaign;
    }

    public function setAutomationCampaign(?InstagramCommentAutomation $automationCampaign): static
    {
