...
try {
    ...
    $pdo->exec("DROP TABLE IF EXISTS broadcast_campaigns");
    $pdo->exec("DROP TABLE IF EXISTS web_widgets");
    
    $sql1 = "CREATE TABLE broadcast_campaigns (
    ...
    $sql1_constraints = "ALTER TABLE broadcast_campaigns ADD CONSTRAINT FK_B22BC48D7E3C61F9 FOREIGN KEY (owner_id) REFERENCES admin (id);
    ALTER TABLE broadcast_campaigns ADD CONSTRAINT FK_B22BC48D80F174B0 FOREIGN KEY (connection_id) REFERENCES whatsapp_connection (id) ON DELETE CASCADE;";
    
    $sql2 = "CREATE TABLE web_widgets (
        id INT AUTO_INCREMENT NOT NULL, 
        owner_id INT NOT NULL, 
        connection_id INT NOT NULL, 
    ...
    $sql2_constraints = "ALTER TABLE web_widgets ADD CONSTRAINT FK_E282714D7E3C61F9 FOREIGN KEY (owner_id) REFERENCES admin (id);
    ALTER TABLE web_widgets ADD CONSTRAINT FK_E282714D80F174B0 FOREIGN KEY (connection_id) REFERENCES whatsapp_connection (id) ON DELETE CASCADE;";
